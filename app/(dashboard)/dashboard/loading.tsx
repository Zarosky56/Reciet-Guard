...
/**
 * Dashboard route loading state — Premium UI Redesign (task 11.3).
 *
 ...
 * (task 11.3 — `ProcessRail` shim deletion).
 */
export default function DashboardLoading() {
  return (
    <div className="fixed inset-x-0 top-16 bottom-16 z-20 flex items-center justify-center md:bottom-0">
      <div className="flex flex-col items-center gap-3 px-6 text-center">
        <Loader size="md" label="Loading dashboard" />
        <p className="text-xs text-text-muted">Fetching your receipts</p>
      </div>
    </div>
  );
}
